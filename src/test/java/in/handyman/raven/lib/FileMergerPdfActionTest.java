...
import in.handyman.raven.lib.model.fileMergerPdf.FileMergerPdfAction;
...
public class FileMergerPdfActionTest {
    ...
    void tritonServer() throws Exception {
        FileMergerPdf filemergerPdf = FileMergerPdf.builder()
                ...
                .outputTable("file_merger.file_merger_result")
                .querySet("SELECT 'oxy_org1' as origin_id ,1 as paper_no,replace(concat('cleaned_pdf_','INT-1','.pdf'),'-','_') as output_file_name, 1 as group_id, ARRAY['/data/output/pdf_to_image/test/test_0.jpg','/data/output/pdf_to_image/test/test_0.jpg'] as filePaths, 1 as tenant_id, 'TMP-1' as template_id, 1 as root_pipeline_id, '138980184199100180' as process_id,'file-1' as fileId;")
