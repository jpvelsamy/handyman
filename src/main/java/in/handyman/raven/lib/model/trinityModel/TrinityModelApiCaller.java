...
public class TrinityModelApiCaller {
    ...
    public TrinityModelResponse compute(final String inputPath, final String paperType, final List<String> questions, ActionExecutionAudit action) throws JsonProcessingException {
        ...
        try (Response response = httpclient.newCall(request).execute()) {
            ...
            if (response.isSuccessful()) {
                TrinityModelResponse trinityModelResponse = MAPPER.readValue(responseBody, new TypeReference<>() {
                });

                return trinityModelResponse;
            } else {
