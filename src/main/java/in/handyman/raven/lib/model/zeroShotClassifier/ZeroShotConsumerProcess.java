...
import java.util.concurrent.TimeUnit;
    ...
    public class ZeroShotConsumerProcess {
...
//
//        private static final String ZERO_SHOT_CLASSIFIER = "ZERO_SHOT_CLASSIFIER";
//
...
//                                ZeroShotClassifierDataItem.().forEach(ZeroShotClassifierDataEntityConfidenceScore -> {
