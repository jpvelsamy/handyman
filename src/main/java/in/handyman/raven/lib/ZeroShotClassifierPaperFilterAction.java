...
public class ZeroShotClassifierPaperFilterAction implements IActionExecution {
    ...
    public void execute() throws Exception {
        ...
        final OkHttpClient httpclient = new OkHttpClient.Builder()
                ...
                .build();
        JSONArray synonymContainerArray = new JSONArray(zeroShotClassifierPaperFilter.getKeysToFilter());
        for (int i = 0; i < synonymContainerArray.length(); i++) {
            final ObjectNode objectNode = mapper.createObjectNode();
            objectNode.put("pageContent", zeroShotClassifierPaperFilter.getPageContent());
            objectNode.set("keysToFilter", mapper.readTree(synonymContainerArray.get(i).toString()));
