...
public class BlankPageRemoverAction implements IActionExecution {
  ...
  public void execute() throws Exception {
    ...
    final String insertQuery = "INSERT INTO info.blank_page_removal_1234" + "(origin_id,group_id,processed_file_path, created_on) " +
            " VALUES(?,?,?,now())";
    ...
    Thread.sleep(1000);
    coproProcessor.startConsumer(insertQuery, 2, 10, new BlankPageRemoverAction.BlankPageRemoverConsumerProcess(log, aMarker, action, outputDir));
