...
public class IntellimatchAction implements IActionExecution {
  ...
  public void execute() throws Exception {
    ...
    try {
      ...
      log.info(aMarker, "intelli match coproProcessor startConsumer called consumer count {} write batch count {} ", Integer.valueOf(action.getContext().get("consumer.API.count")), Integer.valueOf(action.getContext().get("write.batch.size")));
    ...
    public List<IntellimatchOutputTable> process(URL endpoint, IntellimatchInputTable result) throws Exception {
      ...
      if (result.getActualValue() != null) {
        ...
        try (Response response = httpclient.newCall(request).execute()) {
          ...
          HandymanException.insertException("control data comparison consumer failed for originId " + result.originId, handymanException, this.action);
  ...
  @Builder
  @JsonIgnoreProperties(ignoreUnknown = true)
  public static class IntellimatchInputTable implements CoproProcessor.Entity {
  ...
  @Builder
  @JsonIgnoreProperties(ignoreUnknown = true)
  public static class IntellimatchOutputTable implements CoproProcessor.Entity {
    private String fileName;
    private String originId;
    private Integer groupId;
