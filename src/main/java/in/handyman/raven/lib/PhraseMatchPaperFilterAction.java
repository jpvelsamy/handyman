...
//                                .pageContent(Optional.ofNullable(responseObject.get("page_content")).map(String::valueOf).orElse(null))
                    ...
                    .paperNo(paperNo)
                    .build();
            jdbi.useTransaction(handle -> handle.createUpdate("INSERT INTO paper.phrase_match_filtering_result_" + processId + "(origin_id,group_id,paper_no,synonym,is_key_present, created_on)" +
