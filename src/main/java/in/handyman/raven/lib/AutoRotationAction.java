...
public class AutoRotationAction implements IActionExecution {
  ...
  public void execute() throws Exception {
    ...
    final String insertQuery = "INSERT INTO info.auto_rotation_1234" + "(origin_id,group_id,processed_file_path, created_on) " +
            " VALUES(?,?,?,now())";
    ...
    Thread.sleep(1000);
    coproProcessor.startConsumer(insertQuery, 2, 10, new AutoRotationAction.AutoRotationConsumerProcess(log, aMarker, action, outputDir));
