...
public class DBAccess {
    ...
    static {
        ...
        POOL = ConnectionFactories.get(String.format("r2dbc:mariadb://%s:%s@%s:%s/%s?option1=value", username, password, host, port, database));
    ...
    public static void init() {
        if (CONFIG.getBoolean("config.create-on-init")) {
