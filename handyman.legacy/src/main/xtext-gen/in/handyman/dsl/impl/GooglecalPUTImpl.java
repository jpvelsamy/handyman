 ...
 * </p>
 * <ul>
 *   <li>{@link in.handyman.dsl.impl.GooglecalPUTImpl#getAccount <em>Account</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GooglecalPUTImpl#getPrivateKey <em>Private Key</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GooglecalPUTImpl#getPtwelveFile <em>Ptwelve File</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GooglecalPUTImpl#getProject <em>Project</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GooglecalPUTImpl#getImpersonatedUser <em>Impersonated User</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GooglecalPUTImpl#getDbSrc <em>Db Src</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GooglecalPUTImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GooglecalPUTImpl extends ActionImpl implements GooglecalPUT
{
  ...
  {
    return DslPackage.Literals.GOOGLECAL_PUT;
  }
  ...
  public void setAccount(String newAccount)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLECAL_PUT__ACCOUNT, oldAccount, account));
  }
  ...
  public void setPrivateKey(String newPrivateKey)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLECAL_PUT__PRIVATE_KEY, oldPrivateKey, privateKey));
  }
  ...
  public void setPtwelveFile(String newPtwelveFile)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLECAL_PUT__PTWELVE_FILE, oldPtwelveFile, ptwelveFile));
  }
  ...
  public void setProject(String newProject)
  {
    ...
    project = newProject;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLECAL_PUT__PROJECT, oldProject, project));
  }
  ...
  public void setImpersonatedUser(String newImpersonatedUser)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLECAL_PUT__IMPERSONATED_USER, oldImpersonatedUser, impersonatedUser));
  }
  ...
  public void setDbSrc(String newDbSrc)
  {
    ...
    dbSrc = newDbSrc;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLECAL_PUT__DB_SRC, oldDbSrc, dbSrc));
  }
  ...
  public void setValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLECAL_PUT__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DslPackage.GOOGLECAL_PUT__ACCOUNT:
        return getAccount();
      case DslPackage.GOOGLECAL_PUT__PRIVATE_KEY:
        return getPrivateKey();
      case DslPackage.GOOGLECAL_PUT__PTWELVE_FILE:
        return getPtwelveFile();
      case DslPackage.GOOGLECAL_PUT__PROJECT:
        return getProject();
      case DslPackage.GOOGLECAL_PUT__IMPERSONATED_USER:
        return getImpersonatedUser();
      case DslPackage.GOOGLECAL_PUT__DB_SRC:
        return getDbSrc();
      case DslPackage.GOOGLECAL_PUT__VALUE:
        return getValue();
    }
