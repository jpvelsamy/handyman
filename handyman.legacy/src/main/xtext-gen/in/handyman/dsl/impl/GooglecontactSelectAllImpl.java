 ...
 * </p>
 * <ul>
 *   <li>{@link in.handyman.dsl.impl.GooglecontactSelectAllImpl#getAccount <em>Account</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GooglecontactSelectAllImpl#getPrivateKey <em>Private Key</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GooglecontactSelectAllImpl#getPtwelveFile <em>Ptwelve File</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GooglecontactSelectAllImpl#getProject <em>Project</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GooglecontactSelectAllImpl#getImpersonatedUser <em>Impersonated User</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GooglecontactSelectAllImpl#getDbSrc <em>Db Src</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GooglecontactSelectAllImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GooglecontactSelectAllImpl extends ActionImpl implements GooglecontactSelectAll
{
  ...
  {
    return DslPackage.Literals.GOOGLECONTACT_SELECT_ALL;
  }
  ...
  public void setAccount(String newAccount)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLECONTACT_SELECT_ALL__ACCOUNT, oldAccount, account));
  }
  ...
  public void setPrivateKey(String newPrivateKey)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLECONTACT_SELECT_ALL__PRIVATE_KEY, oldPrivateKey, privateKey));
  }
  ...
  public void setPtwelveFile(String newPtwelveFile)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLECONTACT_SELECT_ALL__PTWELVE_FILE, oldPtwelveFile, ptwelveFile));
  }
  ...
  public void setProject(String newProject)
  {
    ...
    project = newProject;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLECONTACT_SELECT_ALL__PROJECT, oldProject, project));
  }
  ...
  public void setImpersonatedUser(String newImpersonatedUser)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLECONTACT_SELECT_ALL__IMPERSONATED_USER, oldImpersonatedUser, impersonatedUser));
  }
  ...
  public void setDbSrc(String newDbSrc)
  {
    ...
    dbSrc = newDbSrc;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLECONTACT_SELECT_ALL__DB_SRC, oldDbSrc, dbSrc));
  }
  ...
  public void setValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLECONTACT_SELECT_ALL__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DslPackage.GOOGLECONTACT_SELECT_ALL__ACCOUNT:
        return getAccount();
      case DslPackage.GOOGLECONTACT_SELECT_ALL__PRIVATE_KEY:
        return getPrivateKey();
      case DslPackage.GOOGLECONTACT_SELECT_ALL__PTWELVE_FILE:
        return getPtwelveFile();
      case DslPackage.GOOGLECONTACT_SELECT_ALL__PROJECT:
        return getProject();
      case DslPackage.GOOGLECONTACT_SELECT_ALL__IMPERSONATED_USER:
        return getImpersonatedUser();
      case DslPackage.GOOGLECONTACT_SELECT_ALL__DB_SRC:
        return getDbSrc();
      case DslPackage.GOOGLECONTACT_SELECT_ALL__VALUE:
        return getValue();
    }
