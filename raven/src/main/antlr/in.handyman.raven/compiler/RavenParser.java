...
public class RavenParser extends Parser {
	...
	public static final int
		...
		NON_ZERO_DIGIT=126, STRING=127, CRLF=128, Operator=129, WS=130, COMMENT=131, 
		LINE_COMMENT=132, NUMBER=133;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'blankPageRemover'", "'docnetAttribution'", "'question-list'", "'documentClassification'", 
	...
	public final TryClauseContext tryClause() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while (((_la) & ~0x3f) == 0 && ((1L << _la) & -7308776345040576384L) != 0 || (((_la - 64)) & ~0x3f) == 0 && ((1L << (_la - 64)) & 23388051137249861L) != 0) {
				{
				{
				setState(118);
	...
	public final DocnetAttributionContext docnetAttribution() throws RecognitionException {
		...
		try {
			...
			match(T__106);
			setState(985);
			((DocnetAttributionContext)_localctx).questionList = match(STRING);
			setState(986);
			match(T__9);
			setState(987);
			match(T__1);
	...
	public static class CheckboxClassificationContext extends ParserRuleContext {
		...
		@Override public int getRuleIndex() { return RULE_checkboxClassification; }
		@Override
		public void enterRule(ParseTreeListener listener) {
