...
public interface RavenListener extends ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by {@link RavenParser#googleContactCreate}.
     *
     * @param ctx the parse tree
     */
    void enterGoogleContactCreate(RavenParser.GoogleContactCreateContext ctx);

    /**
     * Exit a parse tree produced by {@link RavenParser#googleContactCreate}.
     *
     * @param ctx the parse tree
     */
    void exitGoogleContactCreate(RavenParser.GoogleContactCreateContext ctx);

    /**
     * Enter a parse tree produced by {@link RavenParser#googleCalendarCreate}.
     *
     * @param ctx the parse tree
     */
    void enterGoogleCalendarCreate(RavenParser.GoogleCalendarCreateContext ctx);

    /**
     * Exit a parse tree produced by {@link RavenParser#googleCalendarCreate}.
     *
     * @param ctx the parse tree
     */
    void exitGoogleCalendarCreate(RavenParser.GoogleCalendarCreateContext ctx);

    /**
     * Enter a parse tree produced by {@link RavenParser#googleContactFetchAll}.
     *
     * @param ctx the parse tree
     */
    void enterGoogleContactFetchAll(RavenParser.GoogleContactFetchAllContext ctx);

    /**
     * Exit a parse tree produced by {@link RavenParser#googleContactFetchAll}.
     *
     * @param ctx the parse tree
     */
    void exitGoogleContactFetchAll(RavenParser.GoogleContactFetchAllContext ctx);
