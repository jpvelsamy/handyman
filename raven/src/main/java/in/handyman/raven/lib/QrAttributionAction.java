  ...
  public void execute() throws Exception {
    {
      ...
      objectNode.put("outputDir",qrAttribution.getOutputDir());
      // build a request
      Request request = new Request.Builder().url(URI)
              .post(RequestBody.create( objectNode.toString(),MediaTypeJSON)).build();
      log.info(aMarker, "The request got it successfully the File Path and outputDir {} {}",qrAttribution.getFilePath()
              ,qrAttribution.getOutputDir());
      try (Response response = httpclient.newCall(request).execute()) {
        String responseBody = response.body().string();
        String name = qrAttribution.getName() + "-qr-attribution-response";
