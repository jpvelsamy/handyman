      ...
      for (JsonNode sorName : sorList) {
        ...
        if (hitsCount > 0) {
          filterList.hits().hits().forEach(res -> {
            searchBuilderResult.put("key_name", searchKey);
