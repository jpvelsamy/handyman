 ...
 * </p>
 * <ul>
 *   <li>{@link in.handyman.dsl.impl.GoogleSendMailImpl#getAccount <em>Account</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GoogleSendMailImpl#getPrivateKey <em>Private Key</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GoogleSendMailImpl#getPtwelveFile <em>Ptwelve File</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GoogleSendMailImpl#getProject <em>Project</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GoogleSendMailImpl#getImpersonatedUser <em>Impersonated User</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GoogleSendMailImpl#getDbSrc <em>Db Src</em>}</li>
 *   <li>{@link in.handyman.dsl.impl.GoogleSendMailImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GoogleSendMailImpl extends ActionImpl implements GoogleSendMail
{
  ...
  {
    return DslPackage.Literals.GOOGLE_SEND_MAIL;
  }
  ...
  public void setAccount(String newAccount)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLE_SEND_MAIL__ACCOUNT, oldAccount, account));
  }
  ...
  public void setPrivateKey(String newPrivateKey)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLE_SEND_MAIL__PRIVATE_KEY, oldPrivateKey, privateKey));
  }
  ...
  public void setPtwelveFile(String newPtwelveFile)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLE_SEND_MAIL__PTWELVE_FILE, oldPtwelveFile, ptwelveFile));
  }
  ...
  public void setProject(String newProject)
  {
    ...
    project = newProject;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLE_SEND_MAIL__PROJECT, oldProject, project));
  }
  ...
  public void setImpersonatedUser(String newImpersonatedUser)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLE_SEND_MAIL__IMPERSONATED_USER, oldImpersonatedUser, impersonatedUser));
  }
  ...
  public void setDbSrc(String newDbSrc)
  {
    ...
    dbSrc = newDbSrc;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLE_SEND_MAIL__DB_SRC, oldDbSrc, dbSrc));
  }
  ...
  public void setValue(String newValue)
  {
    ...
    value = newValue;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, DslPackage.GOOGLE_SEND_MAIL__VALUE, oldValue, value));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case DslPackage.GOOGLE_SEND_MAIL__ACCOUNT:
        return getAccount();
      case DslPackage.GOOGLE_SEND_MAIL__PRIVATE_KEY:
        return getPrivateKey();
      case DslPackage.GOOGLE_SEND_MAIL__PTWELVE_FILE:
        return getPtwelveFile();
      case DslPackage.GOOGLE_SEND_MAIL__PROJECT:
        return getProject();
      case DslPackage.GOOGLE_SEND_MAIL__IMPERSONATED_USER:
        return getImpersonatedUser();
      case DslPackage.GOOGLE_SEND_MAIL__DB_SRC:
        return getDbSrc();
      case DslPackage.GOOGLE_SEND_MAIL__VALUE:
        return getValue();
    }
