...
public class DslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getSpawnprocessAccess().getGroup(), "rule__Spawnprocess__Group__0");
			builder.put(grammarAccess.getDoglegAccess().getGroup(), "rule__Dogleg__Group__0");
			...
			builder.put(grammarAccess.getStartProcessAccess().getGroup(), "rule__StartProcess__Group__0");
			...
			builder.put(grammarAccess.getSpawnprocessAccess().getNameAssignment_2(), "rule__Spawnprocess__NameAssignment_2");
			builder.put(grammarAccess.getSpawnprocessAccess().getTargetAssignment_4(), "rule__Spawnprocess__TargetAssignment_4");
			builder.put(grammarAccess.getSpawnprocessAccess().getSourceAssignment_6(), "rule__Spawnprocess__SourceAssignment_6");
			builder.put(grammarAccess.getSpawnprocessAccess().getConditionAssignment_8(), "rule__Spawnprocess__ConditionAssignment_8");
			builder.put(grammarAccess.getDoglegAccess().getNameAssignment_2(), "rule__Dogleg__NameAssignment_2");
			builder.put(grammarAccess.getDoglegAccess().getInheritContextAssignment_4(), "rule__Dogleg__InheritContextAssignment_4");
			builder.put(grammarAccess.getDoglegAccess().getProcessListAssignment_7(), "rule__Dogleg__ProcessListAssignment_7");
			builder.put(grammarAccess.getDoglegAccess().getConditionAssignment_10(), "rule__Dogleg__ConditionAssignment_10");
			...
			builder.put(grammarAccess.getStartProcessAccess().getNameAssignment_1(), "rule__StartProcess__NameAssignment_1");
			builder.put(grammarAccess.getStartProcessAccess().getTargetAssignment_3(), "rule__StartProcess__TargetAssignment_3");
