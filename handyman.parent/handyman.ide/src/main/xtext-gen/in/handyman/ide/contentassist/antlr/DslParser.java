...
public class DslParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, DslGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getGoogleSendMailAccess().getGroup(), "rule__GoogleSendMail__Group__0");
			...
			builder.put(grammarAccess.getGoogleSendMailAccess().getNameAssignment_2(), "rule__GoogleSendMail__NameAssignment_2");
			builder.put(grammarAccess.getGoogleSendMailAccess().getAccountAssignment_4(), "rule__GoogleSendMail__AccountAssignment_4");
			builder.put(grammarAccess.getGoogleSendMailAccess().getPrivateKeyAssignment_6(), "rule__GoogleSendMail__PrivateKeyAssignment_6");
			builder.put(grammarAccess.getGoogleSendMailAccess().getPtwelveFileAssignment_8(), "rule__GoogleSendMail__PtwelveFileAssignment_8");
			builder.put(grammarAccess.getGoogleSendMailAccess().getProjectAssignment_10(), "rule__GoogleSendMail__ProjectAssignment_10");
			builder.put(grammarAccess.getGoogleSendMailAccess().getImpersonatedUserAssignment_12(), "rule__GoogleSendMail__ImpersonatedUserAssignment_12");
			builder.put(grammarAccess.getGoogleSendMailAccess().getDbSrcAssignment_14(), "rule__GoogleSendMail__DbSrcAssignment_14");
			builder.put(grammarAccess.getGoogleSendMailAccess().getValueAssignment_17(), "rule__GoogleSendMail__ValueAssignment_17");
			builder.put(grammarAccess.getGoogleSendMailAccess().getConditionAssignment_20(), "rule__GoogleSendMail__ConditionAssignment_20");
